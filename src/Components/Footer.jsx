        ...
        <div>
            <footer className="footer p-10 bg-lime-200 text-base-content">
                <div>
                    ...
                    <a className="link link-hover">Live food</a>
                    <a className="link link-hover">Quick Services</a>
                    <a className="link link-hover">Home Delivary</a>
                    <a className="link link-hover">Super Offers</a>
                </div>
                <div>
            ...
            <footer className="footer px-10 py-4 border-t bg-teal-400 text-base-content border-base-300">
